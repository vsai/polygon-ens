...
contract Domains is ERC721URIStorage {
  ...
  function register(string calldata name) public payable {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        _name,
        '", "description": "A domain on the YSM name service", "image": "data:image/svg+xml;base64,',
  ...
  modifier onlyOwner() {
    // modifier allows you to gchange the behavior of functions
    require(isOwner());
    _; // call the function that is using the modifier
  }
